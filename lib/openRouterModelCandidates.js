/**
 * When `OPENROUTER_MODEL` / `OPENROUTER_MODELS` are unset:
 * 1) Google models on OpenRouter (often different quota than direct Gemini API).
 * 2) Non-Google, relatively cheap vision-capable fallbacks after Google ids fail (quota/rate/404).
 */
