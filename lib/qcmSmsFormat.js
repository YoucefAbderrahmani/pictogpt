...
/** First line: first N characters of the lowest-q question stem (no quotes). */
export const QCM_STEM_SNIPPET_LEN = 7;
...
/** Line 1 + newline + compact line; e.g. `37)___The exa\n37A-38B`. */
...
/**
 * Build QCM SMS body (without photo `slot)__` prefix): line1 = `q___` + first 7 stem chars, line2 = compact key.
