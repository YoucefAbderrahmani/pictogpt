...
- **Never** use a choice-line number (1–5) as **q**; **q** is always the question index as above. Do not confuse a **question** letter (**A=1** … under Priority 3) with an **option** label **A**–**E** inside **choices** for the same question.
